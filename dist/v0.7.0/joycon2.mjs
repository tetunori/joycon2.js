...
class w extends EventTarget {
  constructor() {
    super(), this.data = { ...g }, this.device = null, this.server = null, this.characteristic = null;
  }
  async connect() {
    try {
