...
}, d = "ab7de9be-89fe-49ad-828f-118f09df7fd0", g = "ab7de9be-89fe-49ad-828f-118f09df7fd2";
function o(e, t) {
...
class X extends EventTarget {
  ...
  async connect() {
    try {
      ...
      this.characteristic = await a.getCharacteristic(g), await this.characteristic.startNotifications(), this.characteristic.addEventListener("characteristicvaluechanged", (s) => {
