...
(function () {
  ...
  function createProxyCtor() {
    function ProxyCtor(...ctorArgs) {
      if (!(this instanceof ProxyCtor)) throw new Error('JoyCon2 must be called with new');
  ...
  if (RealCtor) {
    try {
      ...
      try { window.Joycon2 = RealCtor; } catch (e) {}
  ...
  try { window.JoyCon2 = Proxy; } catch (e) {}
  try { window.Joycon2 = Proxy; } catch (e) {}
